...
`struct `[`jungles::small_map`](#structjungles_1_1small__map) | Maps values to specific [jungles::small_register](#classjungles_1_1small__register) instances.
...
Maps values to specific [jungles::small_register](#classjungles_1_1small__register) instances.
